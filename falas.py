...
# texto = topPalavras(importarArquivos(["./Documentos/episodioIVBen.csv", "./Documentos/episodioVLando.csv", "./Documentos/episodioVIVader.csv"]))
...
color_to_words = {
    ...
    'blue' : ['não', 'nunca', 'culpa', 'ruim', 'machucar', 'socorro']
}
